...
class DefferedRenderSystem : public Hollow::System<DefferedRenderSystem>
{
public:
	Shadow shadow;
	Camera* m_Camera;
...
public:
	DefferedRenderSystem(RenderApi* renderer, int width, int height) :
		renderer(renderer), width(width), height(height)
	{
		...
		diffuseBuffer = RenderTargetManager::instance()->create(this->width, this->height);
		normalBuffer = RenderTargetManager::instance()->create(this->width, this->height);
		positionBuffer = RenderTargetManager::instance()->create(this->width, this->height);
