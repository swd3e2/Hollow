...
public:
	TerrainData()
	{
		...
		vBuffer = Hollow::HardwareBufferManager::instance()->createVertexBuffer(vertices.data(), vertices.size());
		iBuffer = Hollow::HardwareBufferManager::instance()->createIndexBuffer(indices.data(), indices.size());
