...
D3D11ShaderManager::D3D11ShaderManager()
{
	...
	for (auto& it : *shaders)
	{
		...
		{
			D3D11VertexShader* vShader = new D3D11VertexShader("C:/dev/Hollow Engine/Hollow/Hollow/Data/Shaders/vertex/" + it);
			D3D11PixelShader * pShader = new D3D11PixelShader("C:/dev/Hollow Engine/Hollow/Hollow/Data/Shaders/pixel/" + it);
