...
VertexBuffer* D3D11HardwareBufferManager::createVertexBuffer(Vertex* data, unsigned int numVertices)
{
...
IndexBuffer* D3D11HardwareBufferManager::createIndexBuffer(unsigned int* data, unsigned int numIndices)
{
