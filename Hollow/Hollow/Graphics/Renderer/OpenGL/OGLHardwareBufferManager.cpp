...
namespace Hollow {
	VertexBuffer* OGLHardwareBufferManager::createVertexBuffer(Vertex* data, size_t numVertices)
	{
	...
	IndexBuffer* OGLHardwareBufferManager::createIndexBuffer(unsigned int* data, size_t numIndices)
	{
