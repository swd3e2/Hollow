...
DepthStencil::DepthStencil(ID3D11Device * device, int width, int height, DXGI_FORMAT format, int samplecount)
{
	HRESULT hr = S_OK;
...
DXGI_FORMAT DepthStencil::GetDepthResourceFormat(DXGI_FORMAT depthformat)
{
...
DXGI_FORMAT DepthStencil::GetDepthSRVFormat(DXGI_FORMAT depthformat)
{
