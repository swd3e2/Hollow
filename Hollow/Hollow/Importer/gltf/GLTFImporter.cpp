...
namespace Hollow {
	void GLTFImporter::processSkin(Hollow::GLTF::Model& lModel, tinygltf::Model& model, std::ifstream& file)
	{
	...
	void GLTFImporter::processAnimationNode(Hollow::AnimationNode* node, const tinygltf::Node& modelNode, Hollow::GLTF::Model& lModel, tinygltf::Model& model)
	{
	...
	void GLTFImporter::processAnimation(Hollow::GLTF::Model& lModel, tinygltf::Model& model, std::ifstream& file)
	{
		// animation
	...
	void GLTFImporter::load(Hollow::GLTF::Node* node, const tinygltf::Node& modelNode, tinygltf::Model& tModel, Hollow::GLTF::Model& model, std::ifstream& file)
	{
	...
	void GLTFImporter::processMesh(Hollow::GLTF::Node* node, tinygltf::Node childModelNode, Hollow::GLTF::Model& model, tinygltf::Model& tModel, std::ifstream& file)
	{
		Hollow::GLTF::LoadedMesh* mesh = new Hollow::GLTF::LoadedMesh();
		...
		if (model.materials.find(tMesh.primitives[0].material) == model.materials.end()) {
			Hollow::GLTF::Material lMaterial;
	...
	Hollow::GLTF::GLTFModel* GLTFImporter::import(const char* filename)
	{
		...
		Hollow::GLTF::Model* lModel = new Hollow::GLTF::Model();
		...
		Hollow::GLTF::GLTFModel* gltfModel = new Hollow::GLTF::GLTFModel();
